...
const plats = [
    ...
    { id: 3, nom: 'Foutou à la sauce graine', prix: 4000, description: 'Le foutou à la sauce graine est un plat savoureux et réconfortant, emblématique de la cuisine ivoirienne', image: 'https://i.pinimg.com/236x/51/6d/1f/516d1f6fe988023f92504b2a8df3474a.jpg?w=300', categorie: 'plats' },
    { id: 4, nom: 'Placali à la sauce graine', prix: 4500, description: 'Accompagné de sauces en graine et kôpè, le placali est bien plus qu un simple accompagnement c est un symbole identité culturelle', image: 'https://i.pinimg.com/736x/6b/c5/27/6bc527f4d6c3549ba4361a591a3dcfa1.jpg?w=300', categorie: 'plats' },
